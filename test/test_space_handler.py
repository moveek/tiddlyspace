...
SYSTEM_URLS = ['http://0.0.0.0:8080/space/system-plugins/',
    'http://0.0.0.0:8080/space/system-info/', 'http://system-applications.0.0.0.0:8080/',
    'http://0.0.0.0:8080/space/system-images/', 'http://system-theme.0.0.0.0:8080/']
...
def test_create_space():
    ...
    assert response['location'] == 'http://0.0.0.0:8080/space/extra/'
